...
<html>
<head>
    <title>Book Brisk Walk Session</title>
 ...
 .nav-cart {
     ...
     <script>
        function calculatePrice() {
            ...
            var pricePerSession = 50; // Adjusted price for Brisk Walk session
...
<main>
    <div class="w3-container header-container">
        <h1>Book Your Brisk Walk Session</h1>
    </div>

    <div class="w3-container details-container">
        <div class="text">
            <h2>Women-Only Brisk Walk Sessions</h2>
            <ol>
                <li><b>Outdoor Fitness:</b> Enjoy brisk walks in beautiful outdoor settings, promoting cardiovascular health.</li>
                <li><b>Guided Sessions:</b> Led by experienced instructors focusing on effective walking techniques.</li>
                <li><b>Group Fitness:</b> Join a supportive group of women for motivation and encouragement.</li>
                <li><b>Flexible Schedule:</b> Choose convenient session times to fit your daily routine.</li>
                <li><b>Duration:</b> Each session typically lasts for 1 hour.</li>
                <li><b>Personal Wellness:</b> Improve fitness levels and overall well-being through regular brisk walks.</li>
                <li><b>Experience the Refreshing Outdoors with Brisk Walk Sessions:</b> Our chosen places are breathtaking and it is comfortable to walk with.</li>
            </ol>
            <p><b>RM50</b> per month </p>
            <p><b>5</b> Session per month</p>
            <p>Join our Brisk Walk sessions and experience the benefits of outdoor fitness in a supportive and empowering environment.</p>
        </div>
    </div>
    ...
    <div class="w3-container booking-container">
        <form method="post" action="">
            ...
            <div class="form-group">
                ...
                <input type="number" id="duration" name="duration" min="1" placeholder="e.g., 5" oninput="calculatePrice()" required>
            </div>
            <div class="form-group">
