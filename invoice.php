...
// Fetch latest 3 bookings for the logged-in user
$sql = "
    ...
    LIMIT 1"; // Limit to the latest booking
...
<html>
<head>
    <title>Invoice - Latest Booking</title>
